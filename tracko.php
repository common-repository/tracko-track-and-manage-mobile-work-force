<?php
/*
Plugin Name: Tracko - Track and Manage Mobile Work Force
Plugin URI: http://tracko.link/
Description: Tracko is a SAS based B2B enterprises solutins to track ,monitor and manage mobile work force for businesses. Using Tracko technology companies can track their mobile assets in real time and can add tasks to perform while they are on field.
Version: 1.0.0
Author: Tracko
